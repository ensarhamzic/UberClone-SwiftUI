...
class AuthViewModel: ObservableObject {
    ...
    func cancelRide(tripId: String) -> Any {
        var result: Any = ""
        
        // URL zahteva
        guard let url = URL(string: Environments.apiBaseURL + "/users/cancelRide") else {
            return result
        }
    ...
    func rewardDriver(tripId: String, tip: Int, rating: Int?) -> Any {
        var result: Any = ""
        
        // URL zahteva
        guard let url = URL(string: Environments.apiBaseURL + "/users/rewardDriver") else {
            return result
        }
